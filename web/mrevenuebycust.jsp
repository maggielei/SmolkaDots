        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h3 class="sub-header">Revenue Report By Customer Name</h3><br>
                                    ...
                                    if (custid == null) {
                                        ...
                                        try {
                                            ...
                                            java.sql.ResultSet rs = stmt1.executeQuery("SELECT I.ItemID,"
                                                    + " B.CurrentWinner AS Buyer, P.CustomerID AS Seller,"
                                                    + "  I.Name, I.Description, I.Type, I.Year, A.CopiesSold,"
                                                    + " SUM(B.WinningBid) AS TotalRevenue FROM Auction A,"
                                                    + " Item I, Post P, Bid B WHERE B.WinningBid IS NOT"
                                                    + " NULL AND B.CurrentWinner = '"+custid+"' AND"
                                                    + " P.ExpireDate < NOW() AND A.ItemID = I.ItemID"
                                                    + " AND P.AuctionID = A.AuctionID AND"
