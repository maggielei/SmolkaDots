        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h3 class="sub-header">Sales Report By Item Name</h3><br>
                                    ...
                                    if (itemname == null) {
                                        ...
                                        try {
                                            ...
                                            java.sql.ResultSet rs = stmt1.executeQuery("SELECT I.ItemID,"
                                                    + " P.CustomerID AS Seller, I.Name, I.Type,"
                                                    + " I.Description, I.Year, A.CopiesSold, SUM(B.BidPrice)"
                                                    + " AS TotalRevenue FROM Auction A, Item I, Post P,"
                                                    + " Bid B WHERE A.ItemID = I.ItemID AND P.ExpireDate"
                                                    + " < NOW() AND A.AuctionID = P.AuctionID AND"
                                                    + " I.Name = '"+itemname+"' AND B.AuctionID = A.AuctionID"
                                                    + " GROUP BY ItemID;");
                                            while (rs.next()) {
                                %>
                                <tr>
