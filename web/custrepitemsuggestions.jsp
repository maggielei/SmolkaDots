            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        ...
                        <li class="active"><a href="custrepsuggestions.jsp">Item Suggestions<span class="sr-only">(current)</span></a></li>
                    </ul>
                </div>
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <%
                                    ...
                                    if (custid == null) {
                                        response.sendRedirect("custrepsuggestions.jsp");
                                    } else {
                                        ...
                                        try {
                                            ...
                                            stmt2.execute("CREATE VIEW CustomerPurchaseTypes AS"
                                                    ...
                                                    + " AND A.AuctionID = P.AuctionID AND B.WinningBid IS NOT NULL AND B.CurrentWinner = '"+custid+"';");
                    ...
                    <button type="button" class="btn btn-default btn-primary" onclick="location.href = 'custrepsuggestions.jsp';">
