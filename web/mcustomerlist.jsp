                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        ResultSet resultset = statement.executeQuery("SELECT P.SSN,"
                                                + " C.CustomerID, P.FirstName, P.LastName, P.Address,"
                                                + " P.City, P.State, P.ZipCode, P.Telephone, P.Email,"
                                                + " C.CreditCardNum, C.Rating FROM Person P, Customer C"
                                                + " WHERE P.SSN = C.CustomerSSN");
                            ...
                            <tbody>
                                <%
                                    ...
                                    try {
                                        ...
                                        Statement statement = conn.createStatement();
                                        ResultSet resultset = statement.executeQuery("SELECT C.CustomerSSN,"
                                                + " C.CustomerID, P.FirstName, P.LastName,"
                                                + " MAX(G.RevenueGenerated) AS RevenueGenerated FROM"
                                                + " GroupedCustomerRevs G, Customer C, Person P WHERE"
                                                + " G.CurrentWinner = C.CustomerID AND C.CustomerSSN = P.SSN;");
                                        while (resultset.next()) {
                                %>
                                <tr>
                                    <td><%=resultset.getString(1)%></td>
